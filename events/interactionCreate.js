...
if(interaction.customId === 'giriscikis'){
  ...
  return interaction.update({ embeds: [embed], components: [row1] })
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      .addComponents(
        ...
        new Discord.ButtonBuilder()
          ...
          .addFields(
            ...
            { name: "**>  /oda-kur**", value: `>  **Odanı Kur sistemini ayarlarsın!**`, inline: true },
            { name: "**>  /odanı-sil**", value: `>  **Odanı Kur'u silersin!**`, inline: true },
            { name: "**>  /oda-kur-menü**", value: `>  **Odanı Kur menüsü!**`, inline: true },
      ...
      .addFields(
        { name: "**>  /oda-kur**", value: `>  **Odanı Kur Sistemini ayarlarsın!**`, inline: true },
        { name: "**>  /odanı-sil**", value: `>  **Odanı silersin!**`, inline: true },
        { name: "**>  /odanı-kur-menü**", value: `>  **Odana kullanıcı eklersin!**`, inline: true }
      )
      .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
      ...
      .addComponents(
        ...
        `)
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.roles.create({ name: 'Ekip', color: "#ffc0cb", permissions: [PermissionsBitField.Flags.SendMessages]});
            interaction.guild.roles.create({ name: 'Dost', color: "#00008b", permissions: [PermissionsBitField.Flags.SendMessages]});
